 ...
 * version.
 *
 * Wunderground is distributed in the hope that it will be useful, but WITHOUT ANY
 ...
 *
 * The Git directory was installed inside assets/components/Wunderground
 *
...
$Chunk->fromArray(array(
    'name' => 'Wundergroundhead',
    'description' => 'Used by the Gmap Snippet: this contains Javascript and CSS styling info that controls the output.',
    'snippet' => file_get_contents('../core/components/'.PKG_NAME_LOWER.'/elements/chunks/chunk.Wundergroundhead.tpl'),
));
